...
const LinkTree = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-pink-50 via-white to-purple-50 flex items-center justify-center p-4" style={{ background: 'linear-gradient(135deg, #f8f8f8, #ffffff)' }}>
      <div className="max-w-md w-full">
        ...
        <div className="text-center mb-8">
          <div className="w-24 h-24 mx-auto mb-4 bg-gradient-to-br from-pink-400 to-purple-500 rounded-full flex items-center justify-center shadow-lg">
            <img src="/LOGO.png" alt="Logo" className="w-23 h-23 rounded-full" />
          </div>
          <h1 className="text-2xl font-bold text-gray-800 mb-2">lovescan.app</h1>
          <p className="text-gray-600 text-sm">Crie um QR Code que dá acesso à uma apresentação personalizada e surpreenda o seu amor! 😍💝✨</p>
        </div>
